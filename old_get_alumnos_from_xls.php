...
//DEPURACION  HAY QUE DESCOMENTARLA//	$archivo=upload_file();
//	$archivo=htmlspecialchars(trim($_POST['Archivo']));;
//DEPURACION	$archivo=solo_archivo($archivo);
//	echo $archivo;
//DEPURACION	$archivo="xls/".$archivo;
...
//		$nombre_apellido=to_human($nombre_apellido);
		$nombre_apellido=to_utf8($nombre_apellido);
	//	$dni=tolatin($dni);
//echo '>>>'.$nombre_apellido.'<br />';
...
//				echo "Alias: [".$alias."] => ".$pass." <hr /> ";
	...
	unset($dnis);
//	echo $excel->dump();
//DEPURACION	redirect_to('admin_test.php');
