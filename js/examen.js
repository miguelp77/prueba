...
//CountDown VALOR EN SEGUNDOS
//if($.cookie('Tiempo')) life = getlife();
//else life= 3600;// En segundos

if($.cookie.get('Tiempo')){
	var timetolife=$.cookie.get('Tiempo');
//	life=10;
}
else {
	var timetolife = 3600; 
//	life = timetolife.getMinutes()+ 3600; 
	$.cookie.set('Tiempo',timetolife);
//	life=20;
	}
//$.cookie.set('Tiempo',null);
$('#cuenta').countdown({until: timetolife, compact: true, timeSeparator: ':',onTick: Galleta ,onExpiry: FIN}); 
function Galleta(periods){
		$.cookie.set('Tiempo',(periods[5]*60+periods[6]));
}
function FIN(){
