...
//Creo TEMA UNICO en la MATERIA elegida
	$sql="INSERT INTO Temas (fk_idAsignatura,Nombre,NConceptos) VALUES ('$Asig_id','$archivo','$unico')";
...
// Enunciado en VARIAS LINEAS			
		if($semaforo==0) $enunciado=$enunciado.$linea;
...
//Añado RESPUESTAS a la CUESTION creada en la BBDD
		if($semaforo==2){ 
			$correcta=0;
			$accion="INSERT INTO Respuestas (Respuesta, Cuestion_id, Correcta) VALUES ('$cuestion','$q_id','$correcta')";
