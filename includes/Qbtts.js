...
//window.self.location.href='cuestiones_by_asig.php?QQ='+sig;
//			window.self.location.href='QCreator.php?QQ='+sig;
		$('#contenedor').load('cuestiones_by_asig.php?QQ='+sig);
		}
	});
	return false;
});

$('a[name=Pre]').click(function(){
 //ANTERIOR CUESTION
 //////////////////////////////////Works!!!!
	var now=$('.redondear').text();
	var ahora=parseInt(now);
