//////////////Works!!!!
//////////////Qnew.php que depende de QCreator.php
////////Hace AJAX a 
//////////////"insert_Q.php",
var strGlobal1="";
var strGlobal2="";
...
//////////////Works!!!!
//MOSTRAR ENUNCIADO
$('.btt[name=VEnun]').live('click',(function() {
...
//	console.log("hola");
	...
	if(NewEnun.length>0){
		...
		$('.Numero').append("<span class='css_button btt' title='Guardar Cuestion' name='saveQ'>Guardar cuestion</span>");
		L_ok=1;
	}
}));

//////Guardar Cuestion
//////Boton creado al insertar un enunciado
